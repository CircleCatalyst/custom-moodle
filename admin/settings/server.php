...
$temp->add(new admin_setting_configselect('sessionhandler', new lang_string('sessionhandler', 'admin'), new lang_string('configsessionhandler', 'admin'), 'database', array('database' => new lang_string('sessionhandlerdatabase', 'admin'),
                                                                                                                                                'memcached' => new lang_string('sessionhandlermemcache', 'admin'),
                                                                                                                                                'file' => new lang_string('sessionhandlerfile', 'admin'))));
...
$temp->add(new admin_setting_configtext('sessionsavepath', new lang_string('sessionsavepath', 'admin'), new lang_string('configmemcachedhosts', 'admin'), '', PARAM_TEXT, 50));
