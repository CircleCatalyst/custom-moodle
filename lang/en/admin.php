...
$string['configsessionhandler'] = 'Changing this setting will require you to re-login. If you select Memcached make sure you set the Memcached Host below.<br /> <strong>Use of File based sessions is not recommened.</strong>';
...
$string['sessionhandler'] = 'Session handler';
$string['sessionhandlerdatabase'] = 'Database';
$string['sessionhandlerfile'] = 'File';
$string['sessionhandlermemcache'] = 'Memcached';
$string['sessionsavepath'] = 'Memcache address';
