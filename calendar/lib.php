...
define('CALENDAR_IMPORT_FILE', 0);
define('CALENDAR_IMPORT_URL',  1);
...
function calendar_import_ical_events($data) {
    global $DB, $USER;
    ...
    foreach($ical->components['VEVENT'] as $event) {
        ...
        if ($data->importfrom == CALENDAR_IMPORT_URL and !empty($data->importurl)) {
            $eventrecord->subscription = $data->importurl;
        }
