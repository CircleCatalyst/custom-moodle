...
/**
 * Strings for component 'theme_linwood', language 'en', branch 'MOODLE_20_STABLE'
 *
 * @package   theme_linwood
 * @copyright 1999 onwards Martin Dougiamas  {@link http://moodle.com}
 * @copyright 2011 Aaron Wells {@link http://www.catalyst.net.nz}
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
$string['pluginname'] = 'Linwood';
...
$string['configtitle'] = 'Linwood settings';
...
<div class="clearfix">
	<div class="theme_screenshot">
		...
		<h2>Linwood</h2>
		<img src="linwood/pix/screenshot.png" />
			</div>
	
	<div class="theme_description">
		
		<h2>About</h2>
		<p>Linwood is a fluid-width, three-column theme ported over to 2.0 from Moodle 1.X.</p>
