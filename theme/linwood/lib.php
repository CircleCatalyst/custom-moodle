 ...
 * @return string
 */
function linwood_process_css($css, $theme) {
	global $CFG;
	...
	$css = linwood_set_colour1($css, $colour1);
	...
	$css = linwood_set_colour2($css, $colour2);
	...
	$css = linwood_set_colour3($css, $colour3);
 ...
 *
 */
function linwood_set_colour1($css, $colour1) {
	$tag = '[[setting:colour1]]';
	$replacement = $colour1;
...
function linwood_set_colour2($css, $colour2) {
	$tag = '[[setting:colour2]]';
	$replacement = $colour2;
	if (is_null($replacement)) {
		$replacement = '#a1a1a1';
...
function linwood_set_colour3($css, $colour3) {
	$tag = '[[setting:colour3]]';
	$replacement = $colour3;
	if (is_null($replacement)) {
		$replacement = '#a1a1a1';
