...
/**
 * Strings for component 'theme_nz_schools', language 'en', branch 'MOODLE_20_STABLE'
 *
...
<div class="clearfix">
	<div class="theme_screenshot">
		...
		<h2>NZ Schools</h2>
		<img src="nz_schools/pix/screenshot.png" />
			</div>
	
	<div class="theme_description">
		
		<h2>About</h2>
		<p>NZ Schools is a fluid-width, three-column theme ported over to 2.0 from Moodle 1.X.</p>
