YUI.add('moodle-theme_chchgirls-colourswitcher', function(Y) {

// Available colours
var COLOURS = ['blue'];

/**
 * Chchgirls theme colour switcher class.
 * Initialise this class by calling M.theme_chchgirls.init
 */
...
ColourSwitcher.prototype = {
    ...
    initializer : function(config) {
        ...
        for (i in COLOURS) {
            ...
            if (Y.one(document.body).hasClass('chchgirls-'+c)) {
                this.set('colour', c);
            }
    ...
    /**
     * Sets the colour being used for the chchgirls theme
    ...
    setColour : function(e, colour) {
        ...
        Y.one(document.body).replaceClass('chchgirls-'+this.get('colour'), 'chchgirls-'+colour);
        // Update the current colour
        this.set('colour', colour);
        // Store the users selection (Uses AJAX to save to the database)
        M.util.set_user_preference('theme_chchgirls_chosen_colour', colour);
    }
};
// Make the colour switcher a fully fledged YUI module
Y.extend(ColourSwitcher, Y.Base, ColourSwitcher.prototype, {
    NAME : 'Chchgirls theme colour switcher',
    ATTRS : {
        colour : {
            value : 'blue'
        }
...
// Our chchgirls theme namespace
M.theme_chchgirls = M.theme_chchgirls || {};
// Initialisation function for the colour switcher
M.theme_chchgirls.initColourSwitcher = function(cfg) {
