...
function avonside_process_css($css, $theme) {
    ...
    $css = avonside_set_regionwidth($css, $regionwidth);
    ...
    $css = avonside_set_customcss($css, $customcss);
 ...
 * @return string
 */
function avonside_set_regionwidth($css, $regionwidth) {
 ...
 * @return string
 */
function avonside_set_customcss($css, $customcss) {
 ...
 *     theme/avonside/yui/avonside/avonside.js
 *
 * @param moodle_page $page 
 */
function avonside_initialise_colourswitcher(moodle_page $page) {
    user_preference_allow_ajax_update('theme_avonside_chosen_colour', PARAM_ALPHA);
    $page->requires->yui_module('moodle-theme_avonside-colourswitcher', 'M.theme_avonside.initColourSwitcher', array(array('div'=>'#colourswitcher')));
}
 ...
 */
function avonside_get_colour($default='blue') {
    return get_user_preferences('theme_avonside_chosen_colour', $default);
}
 ...
 * @return bool
 */
function avonside_check_colourswitch() {
    $changecolour = optional_param('avonsidecolour', null, PARAM_ALPHA);
    if (in_array($changecolour, array('red','green','blue','orange'))) {
        return set_user_preference('theme_avonside_chosen_colour', $changecolour);
    }
    return false;
}