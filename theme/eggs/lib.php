 ...
 * @return string 
 */
function eggs_process_css($css, $theme) {
    ...
    $css = eggs_set_linkcolor($css, $linkcolor);
    ...
    $css = eggs_set_linkhover($css, $linkhover);
    ...
    $css = eggs_set_maincolor($css, $maincolor);
    ...
    $css = eggs_set_maincoloraccent($css, $maincoloraccent);
   ...
   // Set the main headings color
    ...
    $css = eggs_set_headingcolor($css, $headingcolor);
    ...
    $css = eggs_set_blockcolor($css, $blockcolor);
    ...
    $css = eggs_set_forumback($css, $forumback);
    ...
    $css = eggs_set_background($css, $background);
 ...
 *
 */
function eggs_set_linkcolor($css, $linkcolor) {
...
function eggs_set_linkhover($css, $linkhover) {
...
function eggs_set_maincolor($css, $maincolor) {
...
function eggs_set_maincoloraccent($css, $maincoloraccent) {
...
function eggs_set_headingcolor($css, $headingcolor) {
...
function eggs_set_blockcolor($css, $blockcolor) {
...
function eggs_set_forumback($css, $forumback) {
...
function eggs_set_background($css, $background) {
	global $OUTPUT;
...
function eggs_set_logo($css, $logo) {
	global $OUTPUT;
	$tag = '[[setting:logo]]';
	$replacement = $logo;
	if (is_null($replacement)) {
