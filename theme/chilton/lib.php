...
function chilton_process_css($css, $theme) {
    ...
    $css = chilton_set_regionwidth($css, $regionwidth);
    ...
    $css = chilton_set_customcss($css, $customcss);
 ...
 * @return string
 */
function chilton_set_regionwidth($css, $regionwidth) {
 ...
 * @return string
 */
function chilton_set_customcss($css, $customcss) {
 ...
 *     theme/chilton/yui/chilton/chilton.js
 *
 * @param moodle_page $page 
 */
function chilton_initialise_colourswitcher(moodle_page $page) {
    user_preference_allow_ajax_update('theme_chilton_chosen_colour', PARAM_ALPHA);
    $page->requires->yui_module('moodle-theme_chilton-colourswitcher', 'M.theme_chilton.initColourSwitcher', array(array('div'=>'#colourswitcher')));
}
 ...
 */
function chilton_get_colour($default='red') {
    return get_user_preferences('theme_chilton_chosen_colour', $default);
}
 ...
 * @return bool
 */
function chilton_check_colourswitch() {
    $changecolour = optional_param('chiltoncolour', null, PARAM_ALPHA);
    if (in_array($changecolour, array('red','green','blue','orange'))) {
        return set_user_preference('theme_chilton_chosen_colour', $changecolour);
    }
    return false;
}