 ...
 * @return string
 */
function glendowie_process_css($css, $theme) {
	global $CFG;
	...
	$css = glendowie_set_colour1($css, $colour1);
	...
	$css = glendowie_set_colour2($css, $colour2);
	...
	$css = glendowie_set_colour3($css, $colour3);
 ...
 *
 */
function glendowie_set_colour1($css, $colour1) {
	$tag = '[[setting:colour1]]';
	$replacement = $colour1;
...
function glendowie_set_colour2($css, $colour2) {
	$tag = '[[setting:colour2]]';
	$replacement = $colour2;
	if (is_null($replacement)) {
		$replacement = '#a1a1a1';
...
function glendowie_set_colour3($css, $colour3) {
	$tag = '[[setting:colour3]]';
	$replacement = $colour3;
	if (is_null($replacement)) {
		$replacement = '#a1a1a1';
