...
function papnet_process_css($css, $theme) {
    ...
    $css = papnet_set_regionwidth($css, $regionwidth);
    ...
    $css = papnet_set_customcss($css, $customcss);
 ...
 * @return string
 */
function papnet_set_regionwidth($css, $regionwidth) {
 ...
 * @return string
 */
function papnet_set_customcss($css, $customcss) {
 ...
 *     theme/papnet/yui/papnet/papnet.js
 *
 * @param moodle_page $page 
 */
function papnet_initialise_colourswitcher(moodle_page $page) {
    user_preference_allow_ajax_update('theme_papnet_chosen_colour', PARAM_ALPHA);
    $page->requires->yui_module('moodle-theme_papnet-colourswitcher', 'M.theme_papnet.initColourSwitcher', array(array('div'=>'#colourswitcher')));
}
 ...
 */
function papnet_get_colour($default='red') {
    return get_user_preferences('theme_papnet_chosen_colour', $default);
}
 ...
 * @return bool
 */
function papnet_check_colourswitch() {
    $changecolour = optional_param('papnetcolour', null, PARAM_ALPHA);
    if (in_array($changecolour, array('red','green','blue','orange'))) {
        return set_user_preference('theme_papnet_chosen_colour', $changecolour);
    }
    return false;
}