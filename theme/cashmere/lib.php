...
function cashmere_process_css($css, $theme) {
    ...
    $css = cashmere_set_regionwidth($css, $regionwidth);
    ...
    $css = cashmere_set_customcss($css, $customcss);
 ...
 * @return string
 */
function cashmere_set_regionwidth($css, $regionwidth) {
 ...
 * @return string
 */
function cashmere_set_customcss($css, $customcss) {
 ...
 *     theme/cashmere/yui/cashmere/cashmere.js
 *
 * @param moodle_page $page 
 */
function cashmere_initialise_colourswitcher(moodle_page $page) {
    user_preference_allow_ajax_update('theme_cashmere_chosen_colour', PARAM_ALPHA);
    $page->requires->yui_module('moodle-theme_cashmere-colourswitcher', 'M.theme_cashmere.initColourSwitcher', array(array('div'=>'#colourswitcher')));
}
 ...
 */
function cashmere_get_colour($default='blue') {
    return get_user_preferences('theme_cashmere_chosen_colour', $default);
}
 ...
 * @return bool
 */
function cashmere_check_colourswitch() {
    $changecolour = optional_param('cashmerecolour', null, PARAM_ALPHA);
    if (in_array($changecolour, array('red','green','blue','orange'))) {
        return set_user_preference('theme_cashmere_chosen_colour', $changecolour);
    }
    return false;
}