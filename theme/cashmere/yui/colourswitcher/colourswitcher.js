YUI.add('moodle-theme_cashmere-colourswitcher', function(Y) {

// Available colours
var COLOURS = ['blue'];

/**
 * Cashmere theme colour switcher class.
 * Initialise this class by calling M.theme_cashmere.init
 */
...
ColourSwitcher.prototype = {
    ...
    initializer : function(config) {
        ...
        for (i in COLOURS) {
            ...
            if (Y.one(document.body).hasClass('cashmere-'+c)) {
                this.set('colour', c);
            }
    ...
    /**
     * Sets the colour being used for the cashmere theme
    ...
    setColour : function(e, colour) {
        ...
        Y.one(document.body).replaceClass('cashmere-'+this.get('colour'), 'cashmere-'+colour);
        // Update the current colour
        this.set('colour', colour);
        // Store the users selection (Uses AJAX to save to the database)
        M.util.set_user_preference('theme_cashmere_chosen_colour', colour);
    }
};
// Make the colour switcher a fully fledged YUI module
Y.extend(ColourSwitcher, Y.Base, ColourSwitcher.prototype, {
    NAME : 'Cashmere theme colour switcher',
    ATTRS : {
        colour : {
            value : 'blue'
        }
...
// Our cashmere theme namespace
M.theme_cashmere = M.theme_cashmere || {};
// Initialisation function for the colour switcher
M.theme_cashmere.initColourSwitcher = function(cfg) {
