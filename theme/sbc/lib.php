...
/**
 * Library functions for the sbc theme
 *
 * @package   theme_sbc
...
function sbc_process_css($css, $theme) {
    ...
    $css = sbc_set_regionwidth($css, $regionwidth);
    ...
    $css = sbc_set_customcss($css, $customcss);
 ...
 * @return string
 */
function sbc_set_regionwidth($css, $regionwidth) {
 ...
 * @return string
 */
function sbc_set_customcss($css, $customcss) {
 ...
 *     theme/sbc/yui/sbc/sbc.js
 *
 * @param moodle_page $page 
 */
function sbc_initialise_colourswitcher(moodle_page $page) {
    user_preference_allow_ajax_update('theme_sbc_chosen_colour', PARAM_ALPHA);
    $page->requires->yui_module('moodle-theme_sbc-colourswitcher', 'M.theme_sbc.initColourSwitcher', array(array('div'=>'#colourswitcher')));
}
 ...
 */
function sbc_get_colour($default='red') {
    return get_user_preferences('theme_sbc_chosen_colour', $default);
}
 ...
 * @return bool
 */
function sbc_check_colourswitch() {
    $changecolour = optional_param('sbccolour', null, PARAM_ALPHA);
    if (in_array($changecolour, array('red','green','blue','orange'))) {
        return set_user_preference('theme_sbc_chosen_colour', $changecolour);
    }
    return false;
}