...
//sbc_check_colourswitch();
//sbc_initialise_colourswitcher($PAGE);

$bodyclasses = array();
$bodyclasses[] = 'sbc-orange';//.sbc_get_colour();
...
if (!empty($PAGE->theme->settings->tagline)) {
    ...
    $tagline = get_string('defaulttagline', 'theme_sbc');
}
            ...
            <div id="page-header-wrapper" class="wrapper clearfix">
                ...
                <div id="headermenu">
                    <?php if (isloggedin()) {
                        ...
                        echo html_writer::tag('h1', get_string('usergreeting', 'theme_sbc', $USER->firstname));
                        ...
                        $loginlink = html_writer::link(new moodle_url('/login/'), get_string('loginhere', 'theme_sbc'));
                        echo html_writer::tag('h1', get_string('welcome', 'theme_sbc', $loginlink));
                        echo html_writer::end_tag('div');;
                    } ?>
                    ...
                    <div id="colourswitcher">
                        <ul>
                            ...
                            <li><a href="<?php echo new moodle_url($PAGE->url, array('sbccolour'=>'red')); ?>" class="styleswitch colour-red"><img src="<?php echo $OUTPUT->pix_url('red-theme2', 'theme'); ?>" alt="red" /></a></li>
                            <li><a href="<?php echo new moodle_url($PAGE->url, array('sbccolour'=>'green')); ?>" class="styleswitch colour-green"><img src="<?php echo $OUTPUT->pix_url('green-theme2', 'theme'); ?>" alt="green" /></a></li>
                            <li><a href="<?php echo new moodle_url($PAGE->url, array('sbccolour'=>'blue')); ?>" class="styleswitch colour-blue"><img src="<?php echo $OUTPUT->pix_url('blue-theme2', 'theme'); ?>" alt="blue" /></a></li>
                            <li><a href="<?php echo new moodle_url($PAGE->url, array('sbccolour'=>'orange')); ?>" class="styleswitch colour-orange"><img src="<?php echo $OUTPUT->pix_url('orange-theme2', 'theme'); ?>" alt="orange" /></a></li>
                        </ul>
                    </div>
                    -->
