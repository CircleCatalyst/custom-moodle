...
chchgirls_check_colourswitch();
chchgirls_initialise_colourswitcher($PAGE);

$bodyclasses = array();
$bodyclasses[] = 'chchgirls-'.chchgirls_get_colour();
if (!$hassidepre) {
...
if (!empty($PAGE->theme->settings->tagline)) {
    ...
    $tagline = get_string('defaulttagline', 'theme_chchgirls');
}
            ...
            <div id="page-header-wrapper" class="wrapper clearfix">
                ...
                <div id="headermenu">
                    <?php if (isloggedin()) {
                        ...
                        echo html_writer::tag('h1', get_string('usergreeting', 'theme_chchgirls', $USER->firstname));
                    ...
                    <div id="colourswitcher">
                        <ul>
                            ...
                            <li><a href="<?php echo new moodle_url($PAGE->url, array('chchgirlscolour'=>'red')); ?>" class="styleswitch colour-red"><img src="<?php echo $OUTPUT->pix_url('red-theme2', 'theme'); ?>" alt="red" /></a></li>
                            <li><a href="<?php echo new moodle_url($PAGE->url, array('chchgirlscolour'=>'green')); ?>" class="styleswitch colour-green"><img src="<?php echo $OUTPUT->pix_url('green-theme2', 'theme'); ?>" alt="green" /></a></li>
                            <li><a href="<?php echo new moodle_url($PAGE->url, array('chchgirlscolour'=>'blue')); ?>" class="styleswitch colour-blue"><img src="<?php echo $OUTPUT->pix_url('blue-theme2', 'theme'); ?>" alt="blue" /></a></li>
                            <li><a href="<?php echo new moodle_url($PAGE->url, array('chchgirlscolour'=>'orange')); ?>" class="styleswitch colour-orange"><img src="<?php echo $OUTPUT->pix_url('orange-theme2', 'theme'); ?>" alt="orange" /></a></li>
                        </ul>
                    </div>
