...
/**
 * Library functions for the Chchgirls theme
 *
 * @package   theme_chchgirls
 * @copyright 2010 Caroline Kennedy of Synergy Learning
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */

/**
 * Chchgirls theme post process function for CSS
 * @param string $css Incoming CSS to process
 * @param stdClass $theme The theme object
 * @return string The processed CSS
 */
function chchgirls_process_css($css, $theme) {
    ...
    $css = chchgirls_set_regionwidth($css, $regionwidth);
    ...
    $css = chchgirls_set_customcss($css, $customcss);
 ...
 * @return string
 */
function chchgirls_set_regionwidth($css, $regionwidth) {
 ...
 * @return string
 */
function chchgirls_set_customcss($css, $customcss) {
 ...
 *     theme/chchgirls/yui/chchgirls/chchgirls.js
 *
 * @param moodle_page $page 
 */
function chchgirls_initialise_colourswitcher(moodle_page $page) {
    user_preference_allow_ajax_update('theme_chchgirls_chosen_colour', PARAM_ALPHA);
    $page->requires->yui_module('moodle-theme_chchgirls-colourswitcher', 'M.theme_chchgirls.initColourSwitcher', array(array('div'=>'#colourswitcher')));
}
 ...
 */
function chchgirls_get_colour($default='blue') {
    return get_user_preferences('theme_chchgirls_chosen_colour', $default);
}
 ...
 * @return bool
 */
function chchgirls_check_colourswitch() {
    $changecolour = optional_param('chchgirlscolour', null, PARAM_ALPHA);
    if (in_array($changecolour, array('red','green','blue','orange'))) {
        return set_user_preference('theme_chchgirls_chosen_colour', $changecolour);
    }
    return false;
}