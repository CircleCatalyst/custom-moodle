 ...
 * NOTE: that the samllib contains a subset of the simple saml code base 
 *       therefore many options may not be avaiable. 
 * 
 * TODO: make more of these options available to Moodle
 * 
 */
...
$config = array (
	 ...
	 */
	 // TODO: when debugging dev is on AND admin settings tell you to.
	 //       turn debug true
	'debug'                 =>	false, // default to false in production
	'showerrors'            =>	true,
	 ...
	 */
	 // TODO:
	 // My skeletion code makes this irrelviant I think.
	 ...
	 */
	 // TODO:
	 // SECURITY RISK this value most be site dependent
	 // need to give the option to randomize secret salt
	'secretsalt' => 'defaultsecretsalt', // how often does this need to change?
	 ...
	 */
	 // TODO:
	 // Sync this data with moodles admin information
	 // WHICH admin though?
	 ...
	 */
	 // TODO:
	 // Adapt logging to moodles log system
	 // Can log info be written to datadir?
	...
	'enable.saml20-idp'		=> true, // never has to change for moodle
	 ...
	 */
	 // TODO:
	 // make avaiable to the auth plugin config
	 ...
	 */
	// TODO: may need to change this to reflect moodles session naming :/ 
	//
